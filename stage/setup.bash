...
curl -G http://ufpr.dl.sourceforge.net/project/dcm4che/dcm4chee/2.18.0/dcm4chee-2.18.0-psql.zip > /stage/dcm4chee-2.18.0-psql.zip
unzip -q /stage/dcm4chee-2.18.0-psql.zip
DCM_DIR=$DCM4CHEE_HOME/dcm4chee-2.18.0-psql
